...
const Filters = ({ isOpen, setOpen, allItems }: { isOpen: boolean, setOpen: Dispatch<SetStateAction<boolean>>, allItems: {
  types: any[],
  AllItems: any[],
  Heading: string,
} }) => {
  ...
  return (
    <div className='flex flex-col'>
      ...
      <div className='flex flex-col mx-5 gap-10 py-3 font-semibold justify-between'>
        ...
        <div>
          <h1 className='text-xl'>{allItems.Heading}</h1>
        </div>

        <div className='flex flex-wrap gap-8'>
          {allItems.types.map((e, index) => {
            return (
