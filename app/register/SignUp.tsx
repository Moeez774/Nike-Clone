...
const SignUp = () => {
    ...
    useEffect(() => {
        const detectClick = (e: MouseEvent) => {
            if(!inputRef.current?.contains(e.target as Node) && isError) {
                setEmpty(true)
            }
        }
        ...
        <div className='flex flex-col gap-6 my-6 w-10/12 smx:w-[28em]'>
            ...
            <div className='flex flex-col gap-6'>
                ...
                <div className='flex flex-col gap-3'>
                    ...
                    <div>
                        <h1 className='font-medium flex gap-3'>Pakistan <span className='underline text-[gray]'>Change</span></h1>
                    </div>
                </div>
                ...
                <div>
                <div ref={inputRef} className="inputGroupSign w-11/12 smx:w-[28em] flex justify-between" style={{ border: isEmpty? '1px solid #d82b2b': isError? '1px solid black': '1px solid gray' }}>
                    <input autoComplete="off" onClick={error} required={true} type="email" />
                    <label htmlFor="name" aria-required={true} className='font-semibold px-1 py-4' style={{ color: isEmpty? '#d82b2b': isError? 'black': 'gray' }}>Email*</label>
               ...
               { isEmpty && <h1 className='text-[#d82b2b] font-medium ml-3 mt-1 text-xs'>Required</h1> }
                </div>

                {/* Policy */}

                <div className='mr-20 smx:mr-36'>
                    <h1 className='text-[gray]'>By Continuing, I agree to Nike's <span className='underline cursor-pointer'>Privacy Policy</span> and <span className='underline cursor-pointer'>Terms of Use.</span></h1>
                </div>

                <div className='flex justify-center smxx:justify-end my-6'>
                    <button className='py-4 smxx:py-3 px-6 hover:bg-[gray] w-11/12 smxx:w-auto bg-black text-white rounded-3xl'>Continue</button>
                </div>
